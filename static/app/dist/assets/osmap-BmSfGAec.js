import { _ as _export_sfc, D as DashboardConfigurationStore, a as openBlock, c as createElementBlock, e as createCommentVNode } from "./index-xvqfLBaG.js";
class BaseEvent {
  /**
...
const _sfc_main = {
  ...
  async mounted() {
    await fetch(
      ...
      const lineString = new LineString(coordinates2);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return this.osmAvailable ? (openBlock(), createElementBlock("div", _hoisted_1)) : createCommentVNode("", true);
}
const OSMap = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  OSMap as O
};
