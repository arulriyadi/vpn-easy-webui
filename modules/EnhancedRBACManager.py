            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("""
                    ...
                    WHERE type='table' AND name IN (
                        ...
                        'rbac_group_filter_policies', 'rbac_group_nat_policies',
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("""
                    ...
                    FROM rbac_group_filter_policies f
                ...
                cursor.execute("""
                    ...
                    FROM rbac_group_nat_policies n
                ...
                for group in peer_groups:
                    ...
                    for org in organizations:
                        ...
                        cursor.execute("""
                            ...
                            FROM rbac_group_filter_policies
                            WHERE group_id = ? AND organization_id = ?
                        """, (group_id, org_id))
