...
if [ ! -f "static/app/dist/index.html" ]; then
    print_error "Required frontend built files not found. Please ensure static/app/dist/ directory exists with built files."
    exit 1
fi
